...
#define LLTankWar_SCHEME @"LLTankWar"

//开始页面
static NSString *const LLTankWar_routeWithBegin = @"LLTankWar://game/begin";
//菜单
static NSString *const LLTankWar_routeWithMenu = @"LLTankWar://game/menu";
//关于
static NSString *const LLTankWar_routeWithAbout = @"LLTankWar://game/about";
//排行榜
static NSString *const LLTankWar_routeWithRankingList = @"LLTankWar://game/rankingList";
//设置
static NSString *const LLTankWar_routeWithSetting = @"LLTankWar://game/setting";

@interface LLTankWarRoute : NSObject
